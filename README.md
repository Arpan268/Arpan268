...
I am a Computer Science and Engineering graduate specializing in building robust, scalable full-stack applications. I enjoy tackling complex logic, writing clean code, and engineering systems from the ground up using modern web technologies and object-oriented programming principles.
...
When I step away from the keyboard, I am usually focused on pushing my physical and creative limits. You will likely find me:
*   **Power-building:** Training heavy in the gym with a strict push-pull-legs routine (currently chasing a 200kg deadlift).
*   **Trekking:** Exploring high-altitude terrains, from the Kedarkantha summit to the remote ranges of North Sikkim.
*   **Photography:** Capturing and editing photos with a focus on moody, indie, and monochrome aesthetics. 
